...
public class ParticleIO
{
    ...
    public static ParticleSystem loadConfiguredSystem(final InputStream ref, ConfigurableEmitterFactory factory, ParticleSystem system, final Color mask) throws IOException {
        if (factory == null) {
            factory = (ConfigurableEmitterFactory)new ConfigurableEmitterFactory() {
        ...
        try {
            ...
            for (int i = 0; i < list.getLength(); ++i) {
                ...
                system.addEmitter((ParticleEmitter)emitter);
            }
    ...
    private static void elementToEmitter(final Element element, final ConfigurableEmitter emitter) {
        ...
        parseValueElement(getFirstNamedElement(element, "spread"), (ConfigurableEmitter.Value)emitter.spread);
        parseValueElement(getFirstNamedElement(element, "angularOffset"), (ConfigurableEmitter.Value)emitter.angularOffset);
        parseValueElement(getFirstNamedElement(element, "growthFactor"), (ConfigurableEmitter.Value)emitter.growthFactor);
        parseValueElement(getFirstNamedElement(element, "gravityFactor"), (ConfigurableEmitter.Value)emitter.gravityFactor);
        parseValueElement(getFirstNamedElement(element, "windFactor"), (ConfigurableEmitter.Value)emitter.windFactor);
        parseValueElement(getFirstNamedElement(element, "startAlpha"), (ConfigurableEmitter.Value)emitter.startAlpha);
        parseValueElement(getFirstNamedElement(element, "endAlpha"), (ConfigurableEmitter.Value)emitter.endAlpha);
        parseValueElement(getFirstNamedElement(element, "alpha"), (ConfigurableEmitter.Value)emitter.alpha);
        parseValueElement(getFirstNamedElement(element, "size"), (ConfigurableEmitter.Value)emitter.size);
        parseValueElement(getFirstNamedElement(element, "velocity"), (ConfigurableEmitter.Value)emitter.velocity);
        parseValueElement(getFirstNamedElement(element, "scaleY"), (ConfigurableEmitter.Value)emitter.scaleY);
    ...
    private static Element emitterToElement(final Document document, final ConfigurableEmitter emitter) {
        ...
        root.appendChild(createValueElement(document, "spread", (ConfigurableEmitter.Value)emitter.spread));
        root.appendChild(createValueElement(document, "angularOffset", (ConfigurableEmitter.Value)emitter.angularOffset));
        root.appendChild(createValueElement(document, "growthFactor", (ConfigurableEmitter.Value)emitter.growthFactor));
        root.appendChild(createValueElement(document, "gravityFactor", (ConfigurableEmitter.Value)emitter.gravityFactor));
        root.appendChild(createValueElement(document, "windFactor", (ConfigurableEmitter.Value)emitter.windFactor));
        root.appendChild(createValueElement(document, "startAlpha", (ConfigurableEmitter.Value)emitter.startAlpha));
        root.appendChild(createValueElement(document, "endAlpha", (ConfigurableEmitter.Value)emitter.endAlpha));
        root.appendChild(createValueElement(document, "alpha", (ConfigurableEmitter.Value)emitter.alpha));
        root.appendChild(createValueElement(document, "size", (ConfigurableEmitter.Value)emitter.size));
        root.appendChild(createValueElement(document, "velocity", (ConfigurableEmitter.Value)emitter.velocity));
        root.appendChild(createValueElement(document, "scaleY", (ConfigurableEmitter.Value)emitter.scaleY));
