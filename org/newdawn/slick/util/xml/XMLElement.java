...
public class XMLElement
{
    ...
    public int getIntAttribute(final String name) throws SlickXMLException {
        try {
            ...
            throw new SlickXMLException("Value read: '" + this.getAttribute(name) + "' is not an integer", (Throwable)e);
        }
    }
    ...
    public int getIntAttribute(final String name, final int def) throws SlickXMLException {
        try {
            ...
            throw new SlickXMLException("Value read: '" + this.getAttribute(name, "" + def) + "' is not an integer", (Throwable)e);
        }
    }
    ...
    public double getDoubleAttribute(final String name) throws SlickXMLException {
        try {
            ...
            throw new SlickXMLException("Value read: '" + this.getAttribute(name) + "' is not a double", (Throwable)e);
        }
    }
    ...
    public double getDoubleAttribute(final String name, final double def) throws SlickXMLException {
        try {
            ...
            throw new SlickXMLException("Value read: '" + this.getAttribute(name, "" + def) + "' is not a double", (Throwable)e);
        }
    }
