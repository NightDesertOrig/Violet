...
public abstract class GLSLShader
{
    ...
    public GLSLShader(final String fragmentShader) {
        ...
        try {
            final InputStream vertexStream = this.getClass().getResourceAsStream("/shaders/vertex/vertex2.vert");
            vertexShaderID = this.createShader(IOUtils.toString(vertexStream), 35633);
            IOUtils.closeQuietly(vertexStream);
            final InputStream fragmentStream = this.getClass().getResourceAsStream("/shaders/frag/" + fragmentShader + ".frag");
